...
d13c_CO2_input = - 27 ;
CO2_input_GtC = interp1([ -1e6 1980 pars.anthro_CO2(:,1)' ],[ 0 0 pars.anthro_CO2(:,2)'],t) ;
CO2_input = ( CO2_input_GtC * 1e12 )./44 ;


%%% P input
P_input_TgP = interp1([ -1e6 1780 pars.anthro_P(:,1)' ],[ 0 0 pars.anthro_P(:,2)'],t) ;
P_input = ( P_input_TgP * 1e12 )./31 ;
...
%%%% DP_p
dy(23) = phosbenthic_p + phosw - Tran_DP_p_s + Tran_DP_di_p + Mix_DP_di_p  - pripr_p/pars.Red_C_P + remin_p/pars.Red_C_P + P_input ;
